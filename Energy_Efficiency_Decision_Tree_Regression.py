...
#plt.xlabel()
plt.title('Error in Y1 test (Decision Tree Regression)')
plt.suptitle('Error (mean) : '+str(error_y1_test_mean))
plt.savefig('../graph/Energy_Efficiency_DecisionTreeRegression_y1_test_error.png')
plt.show()
...
#plt.xlabel()
plt.title('Error in Y1 train (Decision Tree Regression)')
plt.suptitle('Error (mean) : '+str(error_y1_train_mean))
plt.savefig('../graph/Energy_Efficiency_DecisionTreeRegression_y1_train_error.png')
plt.show()
...
#plt.xlabel()
plt.title('Error in Y2 test (Decision Tree Regression)')
plt.suptitle('Error (mean) : '+str(error_y2_test_mean))
plt.savefig('../graph/Energy_Efficiency_DecisionTreeRegression_y2_test_error.png')
plt.show()
...
plt.savefig('../graph/Energy_Efficiency_DecisionTreeRegression_y2_train_error.png')
plt.show()
